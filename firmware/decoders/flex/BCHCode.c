 ...
 * bb[] = coefficients of redundancy polynomial ( x**(10) i(x) ) modulo g(x)
 */
struct BCHCode bch_s;
struct BCHCode * BCHCode_data;
...
struct BCHCode * BCHCode_New(int p[], int m, int n, int k, int t) {
  ...
  BCHCode_data=&bch_s;
    ...
    BCHCode_data->alpha_to=(int *) p2; 
    BCHCode_data->index_of=(int *) p3; 
    BCHCode_data->p=(int *) p1; 
    BCHCode_data->g=(int *) p4; 
    BCHCode_data->bb=(int *) p5; 
